...
import se.skltp.adapterservices.apse.logging.logentry.LogEntry;


public class MessageInfoLogger {


  public static final String REQ_IN = "se.skltp.adapterservices.apse.logging.req.in";
  public static final String REQ_OUT = "se.skltp.adapterservices.apse.logging.req.out";
  public static final String RESP_IN = "se.skltp.adapterservices.apse.logging.resp.in";
  public static final String RESP_OUT = "se.skltp.adapterservices.apse.logging.resp.out";
  public static final String REQ_ERROR = "se.skltp.adapterservices.apse.logging.error";
