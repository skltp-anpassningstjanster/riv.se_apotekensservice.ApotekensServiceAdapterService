package se.skltp.camel.utils.constants;

public class TjpExchangeProperties {
    ...
    public static final String TjP_X_FORWARDED_PROTO = "httpXForwardedProto";
    public static final String TjP_X_FORWARDED_HOST = "httpXForwardedHost";
    public static final String TjP_X_FORWARDED_PORT = "httpXForwardedPort";
    public static final String EXCHANGE_CREATED = "exchangeCreated";

    private TjpExchangeProperties() {
