...
public class HamtaAktuellaOrdinationerIntegrationTest extends AbstractTestCase {
	...
	private static final String DEFAULT_SERVICE_ADDRESS = getAddress("inbound.endpoint.http.apotekensservice.or.HamtaAktuellaOrdinationer.v4");
	...
	protected String getConfigResources() {
		return "soitoolkit-mule-jms-connector-activemq-embedded.xml," + "ApSeMedicalServicesAdapterIC-common.xml,"
				+ "services/OR-HamtaAktuellaOrdinationer-v4-apse-service.xml,"
				+ "teststub-services/OR-HamtaAktuellaOrdinationer-v4-apse-teststub-service.xml";
	}
