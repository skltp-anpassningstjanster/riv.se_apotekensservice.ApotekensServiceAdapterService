 ...
 */
package se.skltp.adapterservices.apse.apsemedicalservicesadapteric.axs.hamtapatientinfo.v5;
...
import se.riv.se.apotekensservice.axs.hamtapatientinfo.v5.rivtabp21.ApplicationException;
import se.riv.se.apotekensservice.axs.hamtapatientinfo.v5.rivtabp21.HamtaPatientInfoResponderInterface;
import se.riv.se.apotekensservice.axs.hamtapatientinfo.v5.rivtabp21.SystemException;
import se.riv.se.apotekensservice.axs.hamtapatientinforesponder.v5.HamtaPatientInfoRequestType;
import se.riv.se.apotekensservice.axs.hamtapatientinforesponder.v5.HamtaPatientInfoResponseType;

public class HamtaPatientInfoTestProducer implements HamtaPatientInfoResponderInterface {

	@Override
	@WebResult(name = "HamtaPatientInfoResponse", targetNamespace = "urn:riv:se.apotekensservice:axs:HamtaPatientInfoResponder:5", partName = "parameters")
	@WebMethod(operationName = "HamtaPatientInfo", action = "urn:riv:se.apotekensservice:axs:HamtaPatientInfoResponder:5:HamtaPatientInfo")
	public HamtaPatientInfoResponseType hamtaPatientInfo(
			@WebParam(partName = "parameters", name = "HamtaPatientInfo", targetNamespace = "urn:riv:se.apotekensservice:axs:HamtaPatientInfoResponder:5") HamtaPatientInfoRequestType parameters,
