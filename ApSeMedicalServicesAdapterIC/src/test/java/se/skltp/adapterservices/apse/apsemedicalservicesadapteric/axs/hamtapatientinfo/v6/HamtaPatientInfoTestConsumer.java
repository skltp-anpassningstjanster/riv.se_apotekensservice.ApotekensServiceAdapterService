...
public class HamtaPatientInfoTestConsumer {
  ...
  public HamtaPatientInfoTestConsumer(String serviceAddress) {
    ...
    URL cxfConfig =
        HamtaPatientInfoTestConsumer.class
            .getClassLoader()
  ...
  public HamtaPatientInfoResponseType requestIncludingCompleteArgosInformation(
      String socialSecurityNumber, String logicalAddress)
      throws SystemException, ApplicationException {
    ArgosHeaderType argosHeader = createOrganizationArgosHeader();
    HamtaPatientInfoRequestType requestSocialSecurityNumber =
        createSocialSecurityNumberRequest(socialSecurityNumber);
    return _service.hamtaPatientInfo(requestSocialSecurityNumber, logicalAddress, argosHeader);
  }

  private HamtaPatientInfoRequestType createSocialSecurityNumberRequest(
