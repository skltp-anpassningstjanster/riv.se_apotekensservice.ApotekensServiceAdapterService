...
public class ApSeMedicalServicesAdapterICMuleServer {


	public static final String MULE_SERVER_ID   = "ApSeMedicalServicesAdapterIC";
 

	private static final Logger logger = LoggerFactory.getLogger(ApSeMedicalServicesAdapterICMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/ApSeMedicalServicesAdapterIC-config.xml"
        //
