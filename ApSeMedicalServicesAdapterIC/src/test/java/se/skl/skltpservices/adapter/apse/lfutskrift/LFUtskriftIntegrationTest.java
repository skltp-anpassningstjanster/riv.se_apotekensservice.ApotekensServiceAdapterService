...
import static se.skl.skltpservices.adapter.apse.lfutskrift.LFUtskriftTestProducer.*;
...
public class LFUtskriftIntegrationTest extends AbstractTestCase {
	...
	protected String getConfigResources() {
		return "ApSeIntegrationComponent-common.xml,services/LF-LFUtskrift-apse-service.xml,ApSeIntegrationComponent-teststubs-and-services-config.xml";
	}
